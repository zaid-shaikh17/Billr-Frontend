...
import { fetchClients, createClient, updateClient, removeClient } from '../../services/api'
          ...
          <div className='modal-overlay' onClick={closeModal}>
            <div className='modal' onClick={e => e.stopPropagation()}>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className='form-group'>
                  <label>Notes</label>
                  <input name='notes' value={formData.notes} onChange={handleChange} placeholder='Any notes...' />
                </div>
                <div className='modal-actions'>
                  <button type='button' className='btn-cancel' onClick={closeModal}>Cancel</button>
                  <button type='submit' className='btn-primary' disabled={submitting}>
                    {submitting ? 'Saving...' : editingClient ? 'Update' : 'Add Client'}
                  </button>
                </div>
              </form>
            </div>
